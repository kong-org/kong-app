...
const viewStyles = StyleSheet.create({
    ...
    viewFailTop: {
        width: width,
        height: Platform.OS == 'ios' && (height == 812 || height == 844 || height == 896 || height == 926) ? 88 : 64,
    ...
    viewResultsScrollViewTop: {
        alignItems: 'flex-start',
        height: 1/2 * height - (Platform.OS == 'ios' && (height == 812 || height == 844 || height == 896 || height == 926) ? 88 : 64),
        justifyContent: 'center'
    },
