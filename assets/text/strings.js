...
const strings = new LocalizedStrings({
   ...
   'en-US':{
      ...
      // Home.
      textHomeDescription: 'Kong is a physical cryptocurrency. Scan a Kong note via NFC to make sure it is authentic.', // 'Kong is a physical cryptocurrency. Scan Kong notes via NFC to make sure they are real.'
      ...
      textSettingsDescription: 'Kong is a physical cryptocurrency. This app verifies the authenticity of Kong notes using elliptic curve cryptography and the Ethereum blockchain.',
      ...
      textScanTypeDescription: 'Quick verfication confirms the note signed a recent blockhash, but it does not challenge the note directly. Full verfication challenges the secure element, but it is slower, and may not work on all smartphones.',
      ...
      textProcessingTouchNoteIOS: 'Touch your a note to your phone and hold still',
      textProcessingQuickTouchNoteIOS: 'Touch your a note to your phone to scan',
      textProcessingNoteDetectedIOS: 'Note detected, don\'t move while scanning',
      textProcessingUniqueInfoIOS: 'Getting unique note information, don\'t move while scanning',
      ...
      // Fail texts.
            ...
            textFailTimeoutDescription: 'Failed to reopen NFC connection after timeout. Change note orientation and rescan.',
      ...
      textFAQAnswer3: 'The reliability of NFC varies between phones. When scanning, be sure to position the note close to the NFC antenna and try to hold it still during the scanning process. Consult the internet if you do not know where the NFC antenna is located in your phone.',

      textFAQQuestion4: 'The app says my bill is invalid - What do I do?',
      textFAQAnswer4: 'You may sometimes see invalid results due to technical issues during the scanning process. Try scanning multiple times if this happens or re-syncing the gateway nodes via the tap to reset option. Consult our website for more information on the verification process.',

      textFAQQuestion5: 'What is verification checking when I scan a bill?',
      textFAQAnswer5: 'Scanning a KONG bill checks several pieces of information including the ability of the bill to sign a random number and the existing of a smart contract backing the bill. Tap \"Get Instructions\" on the bottom of a valid scan for more information on what information is verified.',

      textFAQQuestion6: 'What does \"Synching Nodes\" mean?',
      textFAQAnswer6: 'Details about devices are stored in merkle trees linked via smart contract and available via IPFS. Periodically the app must sync new merkle tree data from these nodes.',

      textFAQQuestion7: 'Why is the app failing to sync nodes?',
      textFAQAnswer7: 'The Ethereum node may not respond correctly due to rate limiting or your location. Try re-syncing the nodes or changing the Ethereum node the app is attempting to sync from.'
